...
1. **Atomicity-friendly fanout.** Spawn 10 specialists × 2 devices in one parallel wave; each writes its own file; lead collects via filesystem glob. A subagent fanout would also work but the existing teammate template handles it cleanly today.
